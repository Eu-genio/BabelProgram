...
using Babel.Api.Modules.Market.Infrastructure.Charts;
using Babel.Api.Modules.Market.Infrastructure.News;
using Babel.Api.Modules.Market.Infrastructure.Quotes;
...
builder.Services.AddSingleton<MarketNewsQuotaTracker>();
builder.Services.AddHttpClient<YahooFinanceNewsProvider>();
builder.Services.AddHttpClient<MarketauxNewsProvider>();
